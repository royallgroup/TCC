...
int count_spindles_in_ring(const int *first_5A_cluster, const int *second_5A_cluster, int *spindle_particle_id, int *ring_particle_id);
...
int count_spindles_in_ring(const int *first_5A_cluster, const int *second_5A_cluster, int *spindle_particle_id, int *ring_particle_id) {
    ...
    if (spindles_in_ring == 1) {
        (*spindle_particle_id) = first_5A_cluster[3];
        (*ring_particle_id) = first_5A_cluster[4];
        return 1;
    }
    else return 0;
}
