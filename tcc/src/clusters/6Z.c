        ...
        for (first_5A_spindle_id = 0; first_5A_spindle_id < 1; first_5A_spindle_id++) {
            for (j=0; j < nmem_sp3c[first_5A_cluster[first_5A_spindle_id]]; j++) {
                ...
                if (second_5A_id > first_5A_id) {
                    ...
                    if (first_5A_cluster[3] == second_5A_cluster[3] ||
                        first_5A_cluster[3] == second_5A_cluster[4])
                        continue;   // no spindles of 5A_i and 5A_j are common
                    if (first_5A_cluster[4] == second_5A_cluster[3] ||
                        first_5A_cluster[4] == second_5A_cluster[4])
                        continue;
                    ...
                    flg = first_5A_cluster[3] == second_5A_cluster[0] || first_5A_cluster[3] == second_5A_cluster[1] ||
                    ...
                    flg = first_5A_cluster[4] == second_5A_cluster[0] || first_5A_cluster[4] == second_5A_cluster[1] ||
                    ...
                    flg = second_5A_cluster[3] == first_5A_cluster[0] || second_5A_cluster[3] == first_5A_cluster[1] ||
                    ...
                    flg = second_5A_cluster[4] == first_5A_cluster[0] || second_5A_cluster[4] == first_5A_cluster[1] ||
