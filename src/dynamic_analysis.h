...
FILE *fXmol, *fBonds;
char fAnalysisParamsName[1000], fInputParamsName[1000], fXmolParamsName[1000], fXmolName[1000], fBondsName[1000], fDynamicDatName[1000];	// name of parameters file and r... coordinates file and memsize file
...
void Setup_ReadInputParams(char *filename);	// initialize RingStat routine
void Setup_ReadXmolParams(char *filename); // read in .params file
